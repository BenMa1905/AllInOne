...
import { Button, Icon, Container, Input, Stack, Text, HStack, Table, Thead, Tbody, Tfoot, Tr, Th, Td, Heading, IconButton, } from '@chakra-ui/react'
            ...
            return paymentrecords.map(paymentrecord => {
                return (
                    <Tr key={paymentrecord._id}>
                        ...
                        <Td>{paymentrecord.monto_pagado}</Td>
                        <Td>{paymentrecord.Fecha_de_pago}</Td>
                        <Td><IconButton icon={<ViewIcon/>} colorScheme="blue" onClick={() => router.push(`/registro/ver/${paymentrecord._id}`)}/>
                        </Td>
                    </Tr>
                )
            })
...
//         }
//     } catch (error) {
//         // error al obtener el cookie o al decodificar el token, se redirige a otra página o se muestra un mensaje de error
//         return null
//     }
// }
